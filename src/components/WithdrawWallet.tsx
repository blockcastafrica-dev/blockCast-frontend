...
import { X, Wallet, CreditCard, Smartphone, ChevronRight, Shield, ArrowLeft, AlertTriangle } from "lucide-react";
...
const networks: NetworkOption[] = [
  { id: "bep20", name: "BNB Smart Chain", token: "USDT (BEP20)", fee: 0.5, minWithdraw: 10, estimatedTime: "~3 minutes" },
  { id: "erc20", name: "Ethereum", token: "USDT (ERC20)", fee: 5, minWithdraw: 50, estimatedTime: "~5 minutes" },
  { id: "base", name: "Base", token: "USDT (Base)", fee: 0.3, minWithdraw: 10, estimatedTime: "~2 minutes" },
  { id: "trc20", name: "Tron", token: "USDT (TRC20)", fee: 1, minWithdraw: 5, estimatedTime: "~3 minutes" },
];
...
export default function WithdrawWallet({ isOpen, onClose }: WithdrawWalletProps) {
  ...
  const handleMethodClick = (method: string) => {
    if (method === "crypto") {
      ...
      toast.info("This withdrawal method is coming soon!");
    }
  };
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            {step > 1 && (
              <button type="button" onClick={() => setStep(1)} className="p-1">
          ...
          <div className="space-y-4">
            ...
            {amount && Number(amount) > 0 && (
              <div style={{ padding: '16px', backgroundColor: '#1a1f26', borderRadius: '12px' }}>
                ...
                <div className="flex justify-between mb-3">
                  ...
                  <span style={{ color: '#9ca3af' }}>-{selectedNetwork.fee} USDT</span>
                </div>
            ...
            <div className="p-3 bg-orange-500/10 border border-orange-500/20 rounded-xl">
              <div className="flex items-start gap-2">
                ...
                <p className="text-orange-400 text-xs">Make sure your wallet address is correct. Withdrawals to wrong addresses cannot be recovered.</p>
              </div>
            </div>
