...
export const realTimeMarkets: BettingMarket[] = [
  ...
  // MULTIPLE CHOICE MARKETS
  {
    ...
    outcomes: [
      { id: "nigeria", label: "Nigeria", pool: 1625000, odds: 3.33, color: "#06F6FF" },
      { id: "egypt", label: "Egypt", pool: 1355000, odds: 4.0, color: "#05DDFF" },
      { id: "morocco", label: "Morocco", pool: 1084000, odds: 5.0, color: "#5B3AE8" },
      { id: "senegal", label: "Senegal", pool: 813000, odds: 6.67, color: "#432AC5" },
      { id: "other", label: "Other", pool: 543000, odds: 10.0, color: "#2C1CA4" },
    ],
  ...
  },
  {
    ...
    outcomes: [
      ...
      { id: "healthtech", label: "Healthtech", pool: 795000, odds: 4.0, color: "#05DDFF" },
      { id: "agritech", label: "Agritech", pool: 636000, odds: 5.0, color: "#5B3AE8" },
      { id: "cleantech", label: "Clean Energy", pool: 477000, odds: 6.67, color: "#432AC5" },
      { id: "logistics", label: "Logistics", pool: 159000, odds: 20.0, color: "#2C1CA4" },
    ],
  ...
  },
  {
    ...
    isMultipleChoice: true,
    outcomes: [
      { id: "nigeria", label: "Nigeria", pool: 962500, odds: 2.86, color: "#06F6FF" },
      { id: "south-africa", label: "South Africa", pool: 687500, odds: 4.0, color: "#05DDFF" },
      { id: "kenya", label: "Kenya", pool: 550000, odds: 5.0, color: "#5B3AE8" },
      { id: "egypt", label: "Egypt", pool: 412500, odds: 6.67, color: "#432AC5" },
      { id: "other", label: "Other", pool: 137500, odds: 20.0, color: "#2C1CA4" },
    ],
  ...
  {
    id: "multi-disputable-grammy-winner-2025",
    claim: "Who will win Album of the Year at the 2025 Grammy Awards?",
    claimTranslations: {
      en: "Who will win Album of the Year at the 2025 Grammy Awards?",
      fr: "Qui remportera l'Album de l'Année aux Grammy Awards 2025?",
      sw: "Nani atashinda Albamu ya Mwaka katika Tuzo za Grammy 2025?",
    },
    category: "Gossip",
    subcategory: "Music Awards",
    source: "Recording Academy",
    description: "Predict which artist will take home the prestigious Album of the Year award at the 67th Annual Grammy Awards ceremony.",
    totalPool: 4250000,
    yesPool: 0,
    noPool: 0,
    yesOdds: 0,
    ...
    imageUrl: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&ixlib=rb-4.0.3&q=80&w=1080",
  },
];
