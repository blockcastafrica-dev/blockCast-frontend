...
export const realTimeMarkets: BettingMarket[] = [
  ...
  // MULTIPLE CHOICE MARKETS
  {
    ...
    outcomes: [
      ...
      { id: "egypt", label: "Egypt", pool: 1355000, odds: 4.0, color: "#F59E0B" },
      { id: "morocco", label: "Morocco", pool: 1084000, odds: 5.0, color: "#EC4899" },
      { id: "senegal", label: "Senegal", pool: 813000, odds: 6.67, color: "#8B5CF6" },
  ...
  },
  {
    ...
    outcomes: [
      ...
      { id: "south-africa", label: "South Africa", pool: 687500, odds: 4.0, color: "#c5f82a" },
      { id: "kenya", label: "Kenya", pool: 550000, odds: 5.0, color: "#F97316" },
      { id: "egypt", label: "Egypt", pool: 412500, odds: 6.67, color: "#14B8A6" },
