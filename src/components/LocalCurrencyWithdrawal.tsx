...
export default function LocalCurrencyWithdrawal({
  ...
  return (
    <Dialog open={visible} onOpenChange={(open) => !open && handleClose()}>
      <DialogContent className="w-[98vw] sm:max-w-[600px] max-h-[350px] sm:max-h-[90vh] overflow-y-auto border-2 border-purple-500/50 !bg-slate-950 shadow-2xl p-2.5 sm:p-6 gap-1 sm:gap-4">
