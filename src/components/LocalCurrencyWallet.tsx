                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between mb-1">
                            <div className="flex flex-wrap items-center gap-2">
                              ...
                              {method.popular && (
                                <Badge
                                  className="text-[10px] border whitespace-nowrap px-2 py-0.5"
                                  style={{
                          ...
                          {method.id === "card" && (
                            <div className="flex items-center gap-2">
                              ...
                              {/* Mastercard Logo */}
                              <div className="h-5 w-7 bg-white rounded flex items-center justify-center overflow-hidden p-0.5 flex-shrink-0">
