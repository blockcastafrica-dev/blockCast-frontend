...
export default function LocalCurrencyWallet({
  ...
  return (
    <Dialog open={visible} onOpenChange={(open) => !open && handleClose()}>
      <DialogContent
        className="!top-[80px] !left-4 !right-4 !bottom-[100px] !max-h-[calc(100vh-180px)] !translate-x-0 !translate-y-0 sm:!top-[50%] sm:!left-[50%] sm:!right-auto sm:!bottom-auto sm:!max-h-[90vh] sm:!-translate-x-1/2 sm:!-translate-y-1/2 sm:max-w-[600px] overflow-y-auto border-2 border-cyan-500/50 !bg-slate-950 shadow-2xl gap-2 sm:gap-4 rounded-lg p-5 sm:p-6"
      >
