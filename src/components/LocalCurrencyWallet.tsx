...
export default function LocalCurrencyWallet({
  ...
  return (
    <Dialog open={visible} onOpenChange={(open) => !open && handleClose()}>
      <DialogContent className="w-[98vw] sm:max-w-[600px] max-h-[85vh] sm:max-h-[85vh] overflow-y-auto border-2 border-cyan-500/50 !bg-slate-950 shadow-2xl p-3 sm:p-6 gap-2 sm:gap-4">
        ...
        <div className="flex items-center justify-between mb-2 sm:mb-4 p-2 sm:p-3 md:p-4 rounded-xl bg-slate-900 border border-cyan-500/40">
          {[1, 2, 3].map((s) => (
            <div key={s} className="flex items-center flex-1">
              ...
              {s < totalSteps && (
                <div
                  className={`h-0.5 sm:h-1 flex-1 mx-1 sm:mx-2 transition-all rounded-full ${
        ...
        {step === 1 && (
          <div className="space-y-2 sm:space-y-4">
                    ...
                    <CardContent className="p-3 sm:p-4">
                      <div className="flex items-start sm:items-center justify-between gap-2 sm:gap-3">
                        <div className="flex items-start sm:items-center gap-2 sm:gap-3 flex-1 min-w-0">
                          <div className="w-11 h-11 sm:w-14 sm:h-14 flex-shrink-0 rounded-xl bg-gradient-to-br from-cyan-500/20 to-purple-500/20 group-hover:from-cyan-500/30 group-hover:to-purple-500/30 flex items-center justify-center border border-cyan-500/30 transition-all">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1.5 sm:gap-2">
                              ...
                              {method.id === "card" && (
                                <div className="flex items-center gap-1 sm:gap-1.5">
                                  {/* Visa Logo */}
                                  <div className="h-8 w-14 sm:h-10 sm:w-16 rounded flex items-center justify-center flex-shrink-0">
                                  ...
                                  {/* Mastercard Logo */}
                                  <div className="h-8 w-14 sm:h-10 sm:w-16 bg-white rounded flex items-center justify-center overflow-hidden p-0.5 flex-shrink-0">
                              ...
                              {method.id === "crypto" && (
                                <div className="flex items-center gap-1 sm:gap-1.5">
                                  {/* MetaMask Logo */}
                                  <div className="h-7 w-7 sm:h-8 sm:w-8 rounded flex items-center justify-center p-0.5 flex-shrink-0">
                                  ...
                                  <div className="h-7 w-7 sm:h-8 sm:w-8 rounded-xl flex items-center justify-center overflow-hidden flex-shrink-0" style={{ background: 'linear-gradient(135deg, #2E66F8 0%, #124AEB 100%)' }}>
            ...
            <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 rounded-xl p-3 sm:p-4 border border-cyan-500/30 backdrop-blur-sm">
              <div className="flex items-start gap-2 sm:gap-3">
                <div className="p-1.5 sm:p-2 rounded-lg bg-gradient-to-br from-cyan-500/20 to-purple-500/20 border border-cyan-500/30">
                  <Shield className="h-4 w-4 sm:h-5 sm:w-5 text-white flex-shrink-0" />
                </div>
                <div>
                  <h4 className="font-bold text-xs sm:text-sm text-cyan-400">
