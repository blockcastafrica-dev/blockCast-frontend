...
{copied ? (
                  ...
                  <div className="mt-6 px-2">
                    <div className="flex items-baseline gap-3 text-base text-white">
                      <span>Powered by</span>
                      <img src={geminiLogo} alt="Gemini" className="h-5 self-center" />
                      <span>&</span>
                      <div className="flex items-center gap-2 self-center">
                        <svg className="h-5 w-5" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
