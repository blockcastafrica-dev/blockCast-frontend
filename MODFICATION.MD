...
### Changes (commits `c7730a9`, `6aa3b76`, `b28f4ce`, `72c627e`, `670a2f5`, `9903f43`, `5ae834c`, `477acf1`):
- **Mobile Betting UI Background:** Updated to match FundWalletModal styling with `#0f1419` background
- **Border Styling:** Changed to `#1f2937` border for consistency across all modals
- **True Button Color:** Updated to match desktop cyan-400 styling with `rgba(34, 211, 238, ...)` gradient, border, and shadow
- **Desktop Betting Sidebar:** Also updated to use `#0f1419` background and `#1f2937` border
